...
<!-- Titre -->
<!----------->
<h4 class="col-md-6 mx-auto pb-2 border-bottom border-primary  pt-5 my-5" style="width: fit-content;">Informations concernant le compte</h4>
...
<div class="col-md-6 mx-auto">
    <form id="" data-sb-form-api-token="API_TOKEN" method="POST" action="action.php">
        ...
        <!-- Submit Button-->
        <button class="btn btn-secondary btn-sm mb-5" id="submitButton" type="submit" name="modificationsClient">Enregistrer les modifications</button>
    </form>
    <br>
</div>
